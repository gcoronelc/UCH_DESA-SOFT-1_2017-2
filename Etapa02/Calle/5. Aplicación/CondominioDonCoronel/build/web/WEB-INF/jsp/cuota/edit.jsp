                    ...
                    <div class="row-fluid">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="icon-edit"></i><span class="break"></span>Editar cuota</h2>
                            </div>
                            <div class="box-content">
                                <form:form class="form-horizontal" method="POST" action="cuota.htm?action=edit" commandName="cuotax">
                                    <form:hidden path="id"/>
