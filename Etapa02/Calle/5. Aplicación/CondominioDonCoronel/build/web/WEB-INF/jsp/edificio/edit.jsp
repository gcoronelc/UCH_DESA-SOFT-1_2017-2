                    ...
                    <div class="row-fluid">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="icon-edit"></i><span class="break"></span>Editar edificio</h2>
                            </div>
                            <div class="box-content">
                                <form:form class="form-horizontal" method="POST" action="edificio.htm?action=edit" commandName="edificiox">
                                    <form:hidden path="id"/>
                                    <fieldset>
