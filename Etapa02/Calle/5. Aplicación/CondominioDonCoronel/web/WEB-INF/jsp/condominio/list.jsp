                    ...
                    <div class="row-fluid">		
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="icon-user"></i><span class="break"></span>Listado de condominios</h2>
                                <div class="box-icon">
                                    <a href="condominio.htm?action=new">Nuevo condominio</a>
                                </div>
                            </div>
                                        ...
                                        <c:forEach items="${list}" var="c">
                                            <tr>
                                                ...
                                                <td class="center">
                                                    ...
                                                    <a class="btn btn-info" href="condominio.htm?action=get&id=${c.getId()}">
