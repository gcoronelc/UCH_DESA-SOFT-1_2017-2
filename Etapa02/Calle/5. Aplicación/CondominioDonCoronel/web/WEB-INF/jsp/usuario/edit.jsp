                    ...
                    <div class="row-fluid">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="icon-edit"></i><span class="break"></span>Nuevo usuario</h2>
                            </div>
                            <div class="box-content">
                                <form:form class="form-horizontal" method="POST" action="usuario.htm?action=edit" commandName="usuariox">
                                    <form:hidden path="id"/>
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                              <form:input path="correo" class="input-xlarge" required=""></form:input>                                              
                                          </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                              <form:password path="clave" class="input-xlarge" required=""></form:password>
                                          </div>
                                        </div>  
